  ...
  return (
    <section className="relative overflow-hidden bg-[#faf7f2]">
      ...
      <div className="relative mx-auto max-w-4xl px-6 pt-28 pb-24 text-center sm:pt-36 sm:pb-32 lg:pt-44 lg:pb-40">
        ...
        <h1 className="animate-fade-up [animation-delay:150ms] mt-8 text-5xl font-medium leading-[1.05] text-neutral-900 sm:text-6xl lg:text-7xl">
          Discover Stories,
          <br />
          <span className="text-primary">Ideas</span> & Insights
        </h1>

        <p className="animate-fade-up [animation-delay:300ms] mx-auto mt-6 max-w-xl text-base text-muted-foreground sm:text-lg">
        ...
        <div className="animate-fade-up [animation-delay:450ms] mt-10 flex items-center justify-center gap-4">
          <Link
            href="/blog"
            className="group inline-flex h-12 items-center gap-1 rounded-full bg-[#fa66ff] px-7 text-base font-medium text-white shadow-[0_12px_40px_-12px_rgba(184,98,58,0.45)] transition-all hover:-translate-y-0.5 hover:bg-primary"
          >
            Start Reading
          ...
          <Link
            href="#featured"
            className="story-link text-xl font-medium text-neutral-700"
            prefetch={false}
          >
            Browse essays
          </Link>
